    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                {{-- Tombol Sampah --}}
                <a href="{{ route('books.trash') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg shadow-md flex items-center gap-2">
                    {{-- Icon Sampah --}}
                ...
                {{-- Tombol Tambah --}}
                <a href="{{ route('books.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md">
                    + Tambah Buku
                </a>
            </div>
        </div>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500 dark:text-gray-300">
                                        Apakah Anda yakin ingin memindahkan data <span id="deleteName" class="font-bold"></span> ke
                                        <span class="text-red-600 font-bold">Tempat Sampah</span>?
                                    </p>
                                    <p class="text-xs text-gray-400 mt-2">
                                        Data ini tidak akan hilang permanen. Anda bisa memulihkannya (Restore) melalui menu Sampah.
                                    </p>
                                </div>
                            </div>
                        </div>
