                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            @if(Auth::user()->role == 'admin')
                                                <button type="button"
                                                    onclick="openForceDeleteModal('{{ route('books.force_delete', $book->id) }}', '{{ $book->judul }}')"
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500 dark:text-gray-300">
                                        Anda akan menghapus buku <span id="deleteName" class="font-bold text-black dark:text-white"></span> secara permanen dari database.
                                    </p>
                                    <p class="text-xs text-red-600 font-bold mt-3 bg-red-50 p-2 rounded border border-red-200">
                                        ⚠️ PERINGATAN: Data ini TIDAK BISA dipulihkan kembali!
                                    </p>
                                </div>
                            </div>
                        </div>
